...
# Ensure openrouter/ prefix for openrouter provider models
TARGET_MODEL="$LLM_MODEL"
if [[ "$LLM_PROVIDER" == "openrouter" && "$LLM_MODEL" != openrouter/* ]]; then
...
echo "Generated $OUTPUT (provider=$LLM_PROVIDER, model=$TARGET_MODEL)"
